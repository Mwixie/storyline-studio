const CACHE='storyline-v45';
const RUNTIME='storyline-runtime-v45';
const ASSETS=['./','./index.html','./styles.css?v=45','./app.js?v=45','./manifest.webmanifest','./icon.svg','./vendor/qrcode.min.js','./vendor/jsQR.js'];

const CACHE='storyline-v47';
const RUNTIME='storyline-runtime-v47';
const ASSETS=['./','./index.html','./styles.css?v=47','./app.js?v=47','./manifest.webmanifest','./icon.svg','./vendor/qrcode.min.js','./vendor/jsQR.js'];

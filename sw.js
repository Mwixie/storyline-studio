const CACHE='storyline-v46';
const RUNTIME='storyline-runtime-v46';
const ASSETS=['./','./index.html','./styles.css?v=46','./app.js?v=46','./manifest.webmanifest','./icon.svg','./vendor/qrcode.min.js','./vendor/jsQR.js'];
